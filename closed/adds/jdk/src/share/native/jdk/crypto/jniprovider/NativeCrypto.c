...
typedef int OSSL_CRYPTO_num_locks_t(void);
...
OSSL_OPENSSL_free_t* OSSL_OPENSSL_free;
...
JNIEXPORT jint JNICALL Java_jdk_crypto_jniprovider_NativeCrypto_loadCrypto
  (JNIEnv *env, jclass thisObj){
    ...
    if (0 == ossl_ver) {
        ...
        OSSL_OPENSSL_malloc = (OSSL_OPENSSL_malloc_t*)find_crypto_symbol(handle, "OPENSSL_malloc");
        OSSL_OPENSSL_free = (OSSL_OPENSSL_free_t*)find_crypto_symbol(handle, "OPENSSL_free");
        ...
        OSSL_CRYPTO_set_locking_callback = (OSSL_CRYPTO_THREADID_set_callback_t*)find_crypto_symbol(handle, "CRYPTO_set_locking_callback");
    }
...
void thread_setup(void)
{
    ...
    lock_count = (OSSL_OPENSSL_malloc*)((OSSL_CRYPTO_num_locks*)() * sizeof(long));
